...
/**
 * Lightweight line-art icon set (Lucide-style geometry).
 * Stroke-based, 24×24, inherits currentColor — swap-in for emoji across the site.
 */
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  worm: (
    <>
      <path d="M5 20a3 3 0 0 0 6 0v-7.5a3 3 0 0 1 5.2-2" />
      <circle cx="18.5" cy="7" r="2.5" />
      <path d="M18.5 6.5h.01" />
    </>
  ),
  home: (
    <>
